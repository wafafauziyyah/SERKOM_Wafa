...
<body class="bg-gray-50 font-sans text-slate-800 antialiased">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6 lg:p-10">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    ...
                    <div class="flex gap-3">
                        <div class="relative">
                            <input type="text" placeholder="Cari nama / ID..." class="pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 w-full sm:w-64">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-100 text-sm text-slate-700">
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 font-mono text-slate-500">PLG-2023001</td>
                                    <td class="px-6 py-4 font-mono font-medium">5482910293</td>
                                    <td class="px-6 py-4 font-medium text-slate-900">Budi Santoso</td>
                                    <td class="px-6 py-4 truncate max-w-xs">Jl. Merpati No. 45, Jakarta Selatan</td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100">
                                            <i class="bi bi-lightning-fill"></i> 900 VA
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Hapus" onclick="return confirm('Yakin hapus data ini?')">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors group">
                                    ...
                                    <td class="px-6 py-4 font-mono text-slate-500">PLG-2023002</td>
                                    <td class="px-6 py-4 font-mono font-medium">1239847562</td>
                                    <td class="px-6 py-4 font-medium text-slate-900">Siti Aminah</td>
                                    <td class="px-6 py-4 truncate max-w-xs">Komplek Griya Indah Blok A2</td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-amber-50 text-amber-700 border border-amber-100">
                                            <i class="bi bi-lightning-fill"></i> 450 VA
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <button class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"><i class="bi bi-pencil-square"></i></button>
                                            <button class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors"><i class="bi bi-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
                    ...
                    <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
                        <span class="text-sm text-slate-500">Menampilkan 1-10 dari 50 data</span>
                        <div class="flex gap-1">
                            <button class="px-3 py-1 text-sm border border-gray-200 rounded hover:bg-gray-50 text-slate-600">Prev</button>
                            <button class="px-3 py-1 text-sm border border-primary bg-primary text-white rounded">1</button>
                            <button class="px-3 py-1 text-sm border border-gray-200 rounded hover:bg-gray-50 text-slate-600">2</button>
                            <button class="px-3 py-1 text-sm border border-gray-200 rounded hover:bg-gray-50 text-slate-600">Next</button>
                        </div>
                    </div>
                </div>
    ...
    <div id="modalTambah" class="fixed inset-0 z-50 hidden">
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-xl shadow-2xl p-6 border border-gray-100 animate-fade-in-up">
            ...
            <form action="proses_tambah_pelanggan.php" method="POST" class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="username" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none text-sm" placeholder="User login" required>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input type="number" name="nomor_kwh" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none text-sm" placeholder="Contoh: 5482..." required>
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Nama Lengkap</label>
                    <input type="text" name="nama_pelanggan" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none text-sm" placeholder="Sesuai KTP" required>
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Alamat Lengkap</label>
                    <textarea name="alamat" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none text-sm" placeholder="Alamat pemasangan..."></textarea>
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Pilih Daya / Tarif</label>
                    <select name="id_tarif" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary/50 focus:border-primary outline-none text-sm bg-white">
                ...
                <div class="flex justify-end gap-3 mt-6">
                    <button type="button" onclick="toggleModal('modalTambah')" class="px-4 py-2 text-sm font-medium text-slate-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Batal</button>
                    <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-indigo-700 rounded-lg shadow-lg shadow-indigo-500/30 transition-colors">Simpan Data</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        // Simple script to toggle modal visibility
