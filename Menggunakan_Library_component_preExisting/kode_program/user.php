            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6 lg:p-10">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    ...
                    <div class="flex gap-3">
                        <div class="relative">
                            <input type="text" placeholder="Cari user..." class="pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 w-full sm:w-64">
                        ...
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-100 text-sm text-slate-700">
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <button class="p-2 text-slate-300 cursor-not-allowed" disabled><i class="bi bi-trash"></i></button> </div>
                                    </td>
                                </tr>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-slate-500">petugas1</td>
                                    <td class="px-6 py-4">
